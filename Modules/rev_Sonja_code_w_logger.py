...
logging.basicConfig(filename="/home/ayurahman/SprintFinish/Modules/LOVD_rest_api.log", level=logging.DEBUG)


logger = logging.getLogger('LOVD_rest_api')
...
logHandler = handlers.RotatingFileHandler('/home/ayurahman/SprintFinish/Modules/LOVD_rest_api.log', maxBytes=500000, backupCount=2)
